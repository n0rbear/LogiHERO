...
data class Stop(
    ...
    @SerializedName("stop_status") val stopStatus: String = "PENDING",
    @SerializedName("arrival_time") val arrivalTime: Long? = null,
    @SerializedName("actual_departure_time") val actualDepartureTime: Long? = null,
    @SerializedName("segment_distance_km") val segmentDistanceKm: Double? = null,
    @SerializedName("segment_duration_seconds") val segmentDurationSeconds: Long? = null,
    @SerializedName("cumulative_distance_km") val cumulativeDistanceKm: Double? = null,
    @SerializedName("cumulative_duration_seconds") val cumulativeDurationSeconds: Long? = null,
    @SerializedName("route_warning") val routeWarning: String? = null,
