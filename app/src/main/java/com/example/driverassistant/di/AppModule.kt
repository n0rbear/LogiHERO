    ...
    fun provideDatabase(@ApplicationContext context: Context): DriverDatabase {
        return Room.databaseBuilder(
            ...
            .addMigrations(
                ...
                DriverDatabase.MIGRATION_19_20,
                DriverDatabase.MIGRATION_20_21,
                DriverDatabase.MIGRATION_21_22,
                ...
                DriverDatabase.MIGRATION_27_28,
                DriverDatabase.MIGRATION_28_29
            )
            .build()
    }
